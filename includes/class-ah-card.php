...
class Ah_Card {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ah_Card_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Ah_Card_Loader. Orchestrates the hooks of the plugin.
	 * - Ah_Card_i18n. Defines internationalization functionality.
	 * - Ah_Card_Admin. Defines all hooks for the admin area.
	 * - Ah_Card_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ah-card-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-ah-card-admin.php';
	 ...
	 *
	 * Uses the Ah_Card_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Ah_Card_Loader    Orchestrates the hooks of the plugin.
	 */
